...
import type { RawPolicyExtraction, PolicyData, EvidenceBasedField } from "../types/policy";
...
export function transformRawExtraction(
  ...
  const coverageDetails: PolicyData["coverage_details"] = {
    ...
    domiciliary_care: {
      ...
      limit_amount: domiciliaryLimit > 0 ? domiciliaryLimit : null,
      limit_percent: domiciliaryLimit === 0 && isCovered(raw.coverage.domiciliary_hospitalization) ? 10 : null,
